...
class GovTalk
{
	...
	/**
	 * An array containing request options that can be added to the HTTP request
	 * being made to the govnet servers
	 *
	 * @var array
	 */
	...
	/**
	 * Sets request options passed as an array
	 * example array('connect_timeout' => '3')
	 * URL for the result of a submission request.
	 *
	 * @param array $requestOptions Array.
	 */
